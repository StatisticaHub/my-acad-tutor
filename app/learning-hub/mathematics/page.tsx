...
export const metadata: Metadata = {
  ...
  description:
    "A structured mathematics learning pathway covering algebra, calculus, linear algebra, probability, optimisation and quantitative reasoning.",
  alternates: {
    canonical: "https://www.myacademictutor.com/learning-hub/mathematics/",
  },
};
...
const pathway = [
  {
    ...
    body:
      "Build confidence with expressions, equations, inequalities, functions, graphs and symbolic manipulation.",
  },
  {
    step: "02",
    title: "Calculus foundations",
    body:
      "Understand limits, differentiation, integration, rates of change and areas under curves.",
  },
  {
    step: "03",
    title: "Linear algebra",
    body:
      "Study vectors, matrices, systems of equations, transformations and the ideas behind multivariable methods.",
  },
  {
    step: "04",
    title: "Probability and uncertainty",
    body:
      "Connect mathematical probability with statistical reasoning, random variables and uncertainty.",
  },
  {
    step: "05",
    title: "Applied problem-solving",
    body:
      "Use mathematical reasoning to support statistics, data science, modelling and quantitative decision-making.",
  },
];
      ...
      <section className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 rounded-[2rem] border border-[#E4DED2] bg-[#FFFCF6] p-6 shadow-sm md:p-10">
          ...
          <h1 className="mt-4 max-w-5xl text-4xl font-black leading-[1.03] tracking-[-0.055em] md:text-6xl">
            Build the mathematics behind quantitative learning.
          </h1>

          <p className="mt-6 max-w-4xl text-base leading-8 text-[#525252] md:text-lg md:leading-9">
            This pathway supports learners who need stronger mathematical foundations
            for statistics, data science, modelling and applied quantitative subjects.
          </p>
        ...
        <section className="mt-8 rounded-[2rem] border border-[#E4DED2] bg-[#141210] p-6 text-white shadow-sm md:p-8">
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-white/75">
            If you are unsure which mathematical foundation to strengthen, submit an enquiry with your level and topic.
          </p>
