...
function TestTypeSelector({
  ...
  return (
    <div>
      <p className="text-sm font-black text-[#525252]">Alternative hypothesis</p>
...
function LargeNullCurve({
  ...
  return (
    <svg viewBox="0 0 760 340" className="h-auto w-full">
      ...
      <text x={Math.max(70, Math.min(640, zToXLarge(z) - 45))} y="55" fontSize="18" fontWeight="900" fill="#741018">
        z = {z.toFixed(2)}
      </text>
      <text x="70" y="35" fontSize="17" fontWeight="900" fill="#141210">
...
function CriticalRegionPlot({
  ...
  return (
    <svg viewBox="0 0 760 340" className="h-auto w-full">
      ...
      {testType === "two-sided" && (
        <>
          <rect x="60" y="70" width="150" height="200" fill="#741018" opacity="0.12" />
          <rect x="550" y="70" width="150" height="200" fill="#741018" opacity="0.12" />
        </>
      )}
...
function TailShade({
  ...
  return (
    <>
      {testType === "two-sided" && (
        <>
          <rect x="40" y="60" width="95" height="150" fill="#741018" opacity="0.45" />
          <rect x="385" y="60" width="95" height="150" fill="#741018" opacity="0.45" />
        </>
      )}
      {testType === "greater" && (
        <rect x="385" y="60" width="95" height="150" fill="#741018" opacity="0.45" />
