...
export default function StatisticsFoundationCoursePage() {
  return (
    <main className="min-h-screen bg-[#f7f4ee] text-neutral-950">
      <section className="relative overflow-hidden border-b border-neutral-200 bg-white px-6 py-16">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,#f6d8d8,transparent_35%),radial-gradient(circle_at_bottom_left,#fef3c7,transparent_30%)]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-8 text-sm font-semibold uppercase tracking-[0.22em] text-[#8b1116]">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="rounded-full bg-neutral-950 px-7 py-4 text-sm font-semibold text-white transition hover:-translate-y-1 hover:shadow-lg"
                >
                  Start learning
                </a>
                ...
                <a
                  href="#modules"
                  className="rounded-full border border-neutral-300 bg-white px-7 py-4 text-sm font-semibold text-neutral-700 transition hover:-translate-y-1 hover:shadow-md"
                >
                  View all modules
                </a>
                ...
                <a
                  ...
                  className="rounded-full bg-[#8b1116] px-7 py-4 text-sm font-semibold text-white transition hover:-translate-y-1 hover:shadow-lg"
                >
                  Pricing preview
                </a>
              </div>
            ...
            <div className="rounded-[2rem] border border-neutral-200 bg-[#f8f6f1] p-6 shadow-sm">
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                <div className="rounded-2xl bg-white p-4">
                  <p className="text-3xl font-semibold text-neutral-950">5</p>
                  <p className="mt-1 text-sm text-neutral-600">Core modules</p>
                </div>

                <div className="rounded-2xl bg-white p-4">
                  <p className="text-3xl font-semibold text-neutral-950">26</p>
                ...
                <div className="rounded-2xl bg-white p-4">
                  <p className="text-3xl font-semibold text-neutral-950">0</p>
                  <p className="mt-1 text-sm text-neutral-600">Coding required</p>
                </div>

                <div className="rounded-2xl bg-white p-4">
                  <p className="text-3xl font-semibold text-neutral-950">100%</p>
                  <p className="mt-1 text-sm text-neutral-600">Concept focused</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="border-b border-neutral-200 bg-neutral-950 px-6 py-10 text-white">
      ...
      <section className="border-b border-neutral-200 bg-white px-6 py-14">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 grid gap-5 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <div>
              ...
              <h2 className="font-serif-academic mt-3 max-w-4xl text-4xl font-medium leading-tight tracking-[-0.025em] md:text-5xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              href={withBasePath("/interactive-demos")}
              className="rounded-full bg-neutral-950 px-6 py-3 text-center text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:shadow-md"
            >
            ...
            <a
              ...
              className="rounded-full border border-neutral-300 bg-white px-6 py-3 text-center text-sm font-semibold text-neutral-950 transition hover:-translate-y-0.5 hover:shadow-md"
            >
            ...
            <a
              href={withBasePath("/pricing")}
              className="rounded-full bg-[#8b1116] px-6 py-3 text-center text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:shadow-md"
            >
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {modules.map((module) => (
            <a
              ...
              className="group rounded-[1.8rem] border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-[#8b1116]/30 hover:shadow-md"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-3 text-2xl font-semibold tracking-[-0.015em] group-hover:text-[#8b1116]">
                    {module.title}
                  </h3>
                </div>
      ...
      <section className="border-y border-neutral-200 bg-white px-6 py-14">
        <div className="mx-auto max-w-7xl">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#8b1116]">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature}
                className="rounded-[1.5rem] border border-neutral-200 bg-[#f8f6f1] p-5"
              >
                <p className="text-sm leading-7 text-neutral-700">{feature}</p>
              </div>
            ))}
          </div>
        </div>
