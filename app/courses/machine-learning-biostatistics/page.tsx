...
const workflow = [
  {
    ...
    body: "Each lesson begins with the health-data question: what outcome is predicted, for whom, using which variables and at what time?",
  },
  {
    title: "R script",
    body: "Students run a guided R script in the browser and can download the full reproducible version for local study.",
  },
  {
    title: "Outputs",
    body: "The script generates dataset summaries, model results, prediction tables, confusion matrices and performance metrics.",
  },
  {
    title: "Interpretation",
    body: "The lesson explains what each output means statistically, clinically and cautiously.",
  },
  {
    title: "Report",
    body: "Students learn how to write a responsible analysis paragraph from the model output.",
  },
  {
    title: "Cautions",
    body: "Every lesson highlights leakage, overfitting, causal overclaiming, validation limits and clinical usefulness.",
  },
];
      ...
      <section className="mx-auto max-w-7xl">
        ...
        <section className="mt-6 rounded-[1.75rem] border border-[#E4DED2] bg-[#FFFCF6] p-5 shadow-sm md:mt-8 md:rounded-[2.5rem] md:p-10">
          <div className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            ...
            <p className="text-sm leading-7 text-[#525252] md:text-base md:leading-8">
              The course is designed so students do not just run models. They
              learn how to define the prediction problem, run the R workflow,
              interpret the output, write a report and state limitations.
            </p>
          </div>
        ...
        >
          <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <p className="text-sm leading-7 text-[#525252] md:text-base md:leading-8">
              ...
              sequence and the applied skills that will be covered when the
              lessons open fully.
            </p>
          </div>
        ...
        <section className="mt-6 rounded-[1.75rem] border border-[#E4DED2] bg-[#FFFCF6] p-5 shadow-sm md:mt-8 md:rounded-[2.5rem] md:p-10">
          <div className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            ...
            <p className="text-sm leading-7 text-[#525252] md:text-base md:leading-8">
              ...
              R-based lesson release controlled.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-4 text-sm font-black text-[#741018] transition group-hover:translate-x-1">
                    {lesson.open ? "Open lesson →" : "Start learning →"}
                  </p>
                </a>
              );
            })}
        ...
        <section className="mt-6 rounded-[1.75rem] border border-[#E4DED2] bg-[#FFFCF6] p-5 shadow-sm md:mt-8 md:rounded-[2.5rem] md:p-10">
          ...
          <p className="mt-4 max-w-4xl text-sm leading-7 text-[#525252] md:text-base md:leading-8">
            Lesson 1.1 already demonstrates the course format: students run an R
            workflow, inspect dataset summaries, fit a first prediction model,
            review the confusion matrix, interpret sensitivity and specificity,
            and write a cautious clinical prediction report.
          </p>
            ...
            {[
              {
                ...
                body: "Students run browser R code and can download the full script for local study.",
              },
              {
                label: "Output guide",
                title: "Read the results",
                body: "The lesson explains dataset dimensions, outcome balance, model coefficients and performance metrics.",
              },
              {
                label: "Report",
                title: "Write responsibly",
                body: "The report section turns the model output into interpretation, caution and next-step guidance.",
              },
            ].map((item) => (
              <article
                key={item.title}
          ...
          <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
            <div className="p-5 text-white md:p-10">
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-white/75 md:text-base md:leading-8">
                Use this waitlist block for locked lessons. The course is being
                redesigned lesson-by-lesson with advanced R scripts, browser
                coding labs, downloadable files, visual model outputs and
