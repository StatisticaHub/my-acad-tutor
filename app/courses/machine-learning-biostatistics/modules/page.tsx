          ...
          <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
            <div className="p-5 sm:p-6 md:p-10 lg:p-12">
              ...
              <p className="mt-5 max-w-4xl text-base leading-8 text-[#525252] md:mt-6 md:text-lg md:leading-9">
                ...
                course structure. Lesson 1.1 is available now as the full learning
          ...
          <div className="mt-6 grid gap-5">
            {modules.map((module) => (
              <article
                ...
                className="rounded-[1.5rem] border border-[#E4DED2] bg-[#F7F3EA] p-5 md:rounded-[2rem] md:p-6"
              >
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div>
                    ...
                    <p className="mt-3 max-w-4xl text-sm leading-7 text-[#525252]">
                      {module.summary}
                    </p>
                  </div>
                  ...
                  <a
                    href={withBasePath(module.href)}
                    className="inline-flex items-center justify-center rounded-full border border-[#D8CDBB] bg-[#FFFCF6] px-5 py-3 text-sm font-black text-[#141210] transition hover:-translate-y-0.5 hover:border-stone-950"
                  >
                    Module page →
                  </a>
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <span
                            className={`rounded-full border px-3 py-1 text-xs font-black uppercase tracking-[0.14em] ${
                              open
                                ? "border-[#E4DED2] bg-[#F7F3EA] text-[#5F5F5F]"
                        ...
                        <p className="mt-4 text-sm font-black text-[#741018] transition group-hover:translate-x-1">
                          {open ? "Open lesson →" : "Start learning →"}
                        </p>
                      </a>
                    );
                  })}
            ...
            <div className="p-5 text-white md:p-10">
              ...
              <div className="mt-6 grid gap-3">
                {[
                  ...
                  "Lessons 1.2–5.5 remain opening in July 2026.",
