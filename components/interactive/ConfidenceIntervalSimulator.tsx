            ...
            return (
              <g key={interval.index}>
                <line
                  ...
                  stroke="currentColor"
                  strokeWidth="4"
                  className={interval.covers ? "text-[#141210]" : "text-[#741018]"}
                />
                <circle
                  cx={mapX(interval.mean)}
                  cy={y}
                  r="6"
                  className={interval.covers ? "fill-[#141210]" : "fill-[#741018]"}
                />
              </g>
            );
          })}
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        ...
        <label>
          ...
          <select
            ...
            className="mt-3 w-full rounded-2xl border border-[#ded9cf] bg-[#FFFCF6] px-4 py-3 font-semibold"
          >
