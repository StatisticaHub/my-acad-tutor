      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          <a
            ...
            className="inline-flex w-fit items-center justify-center rounded-full border border-neutral-300 bg-white px-5 py-3 text-sm font-black text-neutral-950 transition hover:bg-neutral-950 hover:text-white"
          >
            View all courses →
          </a>
        </div>

        <div className="mt-8 rounded-[2rem] border border-neutral-200 bg-white p-5 shadow-sm md:p-8">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {availableCourses.map((course) => (
              <article
                key={course.title}
                className="rounded-[1.5rem] border border-neutral-200 bg-[#f7f4ee] p-5 transition hover:-translate-y-1 hover:bg-white"
              >
                ...
                <a
                  ...
                  className="mt-5 inline-flex items-center justify-center rounded-full bg-neutral-950 px-5 py-3 text-sm font-black text-white transition hover:bg-[#8b1116]"
                >
                  {course.cta} →
                </a>
              </article>
        ...
        <div className="mt-6 rounded-[2rem] border border-neutral-200 bg-white p-5 shadow-sm md:p-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.2em] text-[#8b1116]">
                Upcoming courses
            ...
            <a
              ...
              className="inline-flex w-fit items-center justify-center rounded-full bg-neutral-950 px-5 py-3 text-sm font-black text-white transition hover:bg-[#8b1116]"
            >
              Join waitlist →
            </a>
          </div>
            ...
            {upcomingCourses.map((course) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="rounded-full border border-[#8b1116]/20 bg-white px-3 py-1 text-[0.7rem] font-black uppercase tracking-[0.14em] text-[#8b1116]">
                    Coming soon
                  </span>
                </div>
                ...
                <a
                  href="#course-waitlist"
                  className="mt-5 inline-flex items-center justify-center rounded-full border border-neutral-300 bg-white px-5 py-3 text-sm font-black text-neutral-950 transition hover:bg-neutral-950 hover:text-white"
                >
                  Join waitlist →
                </a>
              </article>
