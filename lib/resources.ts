...
export const resourceGuides: ResourceGuide[] = [
 ...
 checklist: [
 "Have you defined the primary research question?",
 "Have you identified the primary outcome?",
 "Is the goal hypothesis testing, estimation, prediction or feasibility?",
 "Have you specified a meaningful effect size?",
 "Have you considered variability or baseline event rate?",
 "Have you considered power if testing is the main goal?",
 "Have you considered precision if estimation is the main goal?",
 "Have you allowed for missing data or dropout?",
 "Have you considered events rather than only participants where relevant?",
 "Have you reported assumptions clearly?",
 "Have you avoided post-hoc power interpretation?",
 "Have you discussed uncertainty and confidence intervals?",
 ],
 commonMistakes: [
 "Choosing a sample size without defining the primary outcome.",
 "Reporting a sample size number without assumptions.",
 "Confusing power with the probability that the null hypothesis is false.",
 "Using post-hoc power to explain a non-significant result.",
 "Ignoring missing data and dropout.",
 "Ignoring the number of events in logistic or survival analysis.",
 "Assuming a larger sample fixes bias.",
 "Treating statistical significance as practical importance.",
 "Ignoring precision and confidence interval width.",
 "Using unrealistic effect sizes to make the required sample smaller.",
 ],
 related: [
 "Understanding p-values, confidence intervals and effect sizes",
 "Missing data: deletion, imputation and reporting",
 ...
 checklist: [
 "Have you defined the event clearly?",
 "Have you defined time zero?",
 "Have you defined censoring rules?",
 "Have you reported follow-up time?",
 "Have you counted events and censored observations?",
 "Have you plotted Kaplan-Meier curves where useful?",
 "Have you used the log-rank test only for unadjusted comparison?",
 "Have you used Cox regression when adjustment is needed?",
 "Have you interpreted hazard ratios correctly?",
 "Have you checked proportional hazards?",
 "Have you considered informative censoring?",
 "Have you discussed survival-analysis limitations?",
 ],
 commonMistakes: [
 "Treating time-to-event outcomes as simple binary outcomes.",
 "Ignoring different follow-up durations.",
 "Ignoring censoring.",
 "Calling Kaplan-Meier curves simple line graphs without explaining survival probability.",
 "Using the log-rank test when adjusted analysis is required.",
 "Interpreting hazard ratios as risk ratios.",
 "Ignoring proportional hazards.",
 "Reporting Cox output without defining the event.",
 "Failing to report the number of events.",
 "Making strong causal claims from observational survival data.",
 ],
 related: [
 "Sample size, power and precision explained",
 "Logistic regression explained for health and social science students",
 ...
 checklist: [
 "Have you identified the unit of observation?",
 "Have you identified clustering or repeated measurements?",
 "Have you defined the outcome?",
 "Have you defined fixed-effect predictors?",
 "Have you justified the random-effects structure?",
 "Have you considered a random intercept?",
 "Have you justified any random slopes?",
 "Have you checked whether the model converged?",
 "Have you interpreted fixed effects correctly?",
 "Have you described random effects clearly?",
 "Have you considered missing data and confounding?",
 "Have you reported the model structure transparently?",
 ],
 commonMistakes: [
 "Using ordinary regression for repeated-measures data.",
 "Ignoring clustering within hospitals, schools or subjects.",
 "Adding random effects without understanding why.",
 "Confusing fixed effects with random effects.",
 "Using random slopes without enough data.",
 "Reporting mixed-model output without describing the model structure.",
 "Assuming mixed models automatically prove causation.",
 "Ignoring convergence warnings.",
 "Overfitting complex random-effects structures.",
 "Forgetting that missing data assumptions still matter.",
 ],
 related: [
 "Linear regression assumptions and diagnostics",
 ...
 "Are observations independent or repeated?",
 "Have you avoided multiple t-tests?",
 "Have you checked group means and variation?",
 "Have you considered equal variance?",
 "Have you chosen post-hoc tests carefully?",
 "Do you need covariate adjustment?",
 "Have you interpreted adjusted means correctly?",
 "Have you reported effect sizes or confidence intervals?",
 ],
 commonMistakes: [
 "Using many t-tests instead of ANOVA.",
 "Thinking ANOVA shows exactly which groups differ.",
 "Skipping post-hoc comparisons after a significant overall result.",
 "Performing post-hoc tests without correction.",
 "Using ANCOVA without explaining covariates.",
 "Ignoring interactions.",
 "Ignoring unequal variance.",
 "Reporting only p-values.",
 "Calling adjusted means raw means.",
 "Ignoring whether differences are practically meaningful.",
 ],
 related: [
 "Non-parametric tests: when and how to use them",
 "How to choose the correct statistical test",
