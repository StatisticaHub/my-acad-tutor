              ...
              >
                <div className="grid gap-6 lg:grid-cols-[0.18fr_1fr_0.7fr] lg:items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-5 text-sm font-black text-white group-hover:text-[#8b1116]">
                      Continue →
                    </p>
                  </div>
                  ...
                  <div className="grid gap-2">
                    {route.bestFor.map((item) => (
                      <div
                        key={item}
                        className="rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm font-bold leading-6 text-[#111111]/90"
                      >
                        {item}
                      </div>
                    ))}
