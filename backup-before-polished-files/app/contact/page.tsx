        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <article className="rounded-[2rem] border border-neutral-200 bg-white p-6 text-[#111111] shadow-sm md:p-8">
            ...
            <a
              ...
              className="mt-7 inline-flex w-full items-center justify-center rounded-full border border-[#ded9cf] bg-[#f7f4ee] px-6 py-3 text-sm font-black text-[#111111] transition hover:-translate-y-0.5 hover:bg-white/15 sm:w-auto"
            >
          ...
          <article className="rounded-[2rem] border border-[#ded9cf] bg-white p-6 text-[#111111] shadow-sm md:p-8">
            ...
            <div className="mt-5 rounded-3xl bg-[#f7f4ee] p-5 text-sm leading-7 text-[#111111]/90">
