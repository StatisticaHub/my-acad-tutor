          ...
          <article className="rounded-[2rem] border border-[#ded9cf] bg-white p-6 text-[#111111] shadow-sm md:p-8">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <a
                ...
                className="inline-flex w-full items-center justify-center rounded-full border border-white/25 px-6 py-3 text-sm font-black text-[#111111] transition hover:-translate-y-0.5 hover:bg-white/10 sm:w-auto"
              >
                Request support
              </a>
            </div>
