    ...
    <main className="min-h-screen bg-[#f7f4ee] px-5 py-10 text-[#111111] md:px-8 md:py-16">
      <section className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="mt-6 rounded-[1.75rem] border border-neutral-200 bg-[#f7f4ee] p-5">
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a
                  ...
                  className="inline-flex w-full items-center justify-center rounded-full bg-white px-5 py-3 text-sm font-black text-[#111111] transition hover:-translate-y-0.5 sm:w-auto"
                >
                  Review module →
                </a>
          ...
          <article className="rounded-[2rem] bg-white p-6 text-[#111111] shadow-sm md:p-8">
            ...
            <div className="mt-6 rounded-3xl border border-white/10 bg-white/5 p-5 font-mono text-xs leading-7 text-neutral-700">
              {`# Coming soon
        ...
        <section className="mt-8 rounded-[2rem] border border-[#ded9cf] bg-white p-6 text-[#111111] shadow-sm md:p-8">
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            ...
            <div className="grid gap-3">
              ...
              <a
                href={withBasePath("/pricing")}
                className="rounded-full border border-white/25 bg-white/10 px-6 py-4 text-center text-sm font-black text-[#111111] transition hover:-translate-y-0.5"
              >
                View pricing preview
              </a>
            </div>
