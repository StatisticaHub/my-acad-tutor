      ...
      <section className="mx-auto max-w-7xl">
          ...
          {tiers.map((tier) => (
            <article
              ...
              className={`rounded-[2rem] border p-6 shadow-sm md:p-7 ${
                tier.highlighted
                  ? "border-[#8b1116] bg-white text-[#111111]"
            ...
            >
              ...
              <p
                className={`mt-5 font-sans text-4xl font-black tracking-[-0.05em] ${
                  tier.highlighted ? "text-[#111111]" : "text-[#111111]"
                }`}
              >
                {tier.price}
              </p>
              ...
              <p
                className={`mt-2 text-sm font-bold ${
                  tier.highlighted ? "text-neutral-700" : "text-neutral-700"
                }`}
              >
                {tier.period}
              </p>
        ...
        <section className="mt-8 rounded-[2rem] border border-neutral-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-8 overflow-hidden rounded-[1.5rem] border border-neutral-200">
            <div className="grid grid-cols-4 bg-white text-xs font-black uppercase tracking-[0.16em] text-[#111111]">
