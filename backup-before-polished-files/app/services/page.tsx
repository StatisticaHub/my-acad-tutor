        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <article className="rounded-[2rem] border border-neutral-200 bg-white p-6 text-[#111111] shadow-sm md:p-8">
            ...
            <a
              ...
              className="mt-7 inline-flex w-full items-center justify-center rounded-full border border-white/20 bg-white/10 px-6 py-3 text-sm font-black text-[#111111] transition hover:-translate-y-0.5 hover:bg-white/15 sm:w-auto"
            >
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            ...
            <div className="grid gap-3">
              ...
              <a
                ...
                className="rounded-full border border-white/25 px-6 py-4 text-center text-sm font-black text-neutral-700 transition hover:bg-white/10"
              >
                Browse resources
              </a>
            </div>
