            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span
                  className={`rounded-full border px-3 py-1 text-xs font-black ${
                    course.dark
                      ? "border-[#ded9cf] !text-neutral-700"
              ...
              <p
                className={`mt-5 text-pretty text-base leading-8 ${
                  course.dark ? "!text-neutral-700" : "text-neutral-700"
                }`}
              >
                {course.description}
              </p>
        ...
        <section className="mt-6 rounded-[2rem] border border-neutral-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <a
              ...
              className="inline-flex w-full items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-black !text-[#111111] transition hover:-translate-y-0.5 hover:bg-white sm:w-auto"
            >
              View all courses
            </a>
