...
export default function ContactCTA() {
  return (
    <section className="bg-[#f7f4ee] px-5 py-10 !text-white md:px-8 md:py-16">
      <div className="mx-auto max-w-7xl">
        <section className="rounded-[2rem] border border-neutral-200 bg-white p-6 !text-[#111111] shadow-sm md:p-10">
          ...
          <div className="mt-5 grid gap-8 lg:grid-cols-[1.12fr_0.88fr] lg:items-start">
                  ...
                  <a
                    ...
                    className={`rounded-[1.75rem] border p-5 transition hover:-translate-y-0.5 ${
                      route.dark
                        ...
                        : "border-[#ded9cf] bg-[#f7f4ee] !text-[#111111] hover:bg-[#f7f4ee]"
                    }`}
                  >
                    ...
                    <p
                      className={`mt-3 text-sm leading-7 ${
                        route.dark ? "text-white/90" : "!text-white/90"
                      }`}
                    >
                      {route.description}
                    </p>
            ...
            <aside className="rounded-[2rem] border border-[#ded9cf] bg-[#f7f4ee] p-5 md:p-6">
              <p className="text-sm font-black uppercase tracking-[0.22em] !text-white/90">
                Best for
              </p>
              ...
              <div className="mt-5 grid gap-3">
                {supportAreas.map((area) => (
                  <div
                    key={area}
                    className="rounded-2xl border border-[#ded9cf] bg-[#f7f4ee] px-4 py-3 text-sm font-bold leading-6 !text-[#111111]/90"
                  >
                    {area}
                  </div>
                ))}
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center rounded-full border border-[#ded9cf] px-6 py-3 text-sm font-black !text-white transition hover:-translate-y-0.5 hover:bg-[#f7f4ee] sm:w-auto"
            >
              Email directly
            </a>
